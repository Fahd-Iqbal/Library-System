...
public class Update_1_book extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BookRepository.getInstance(getServletContext()).updateBook((Session) request.getSession().getAttribute("someUser"), id, book);
            ...
            if (mimeType.contains("image/")) {
                BookRepository.getInstance(getServletContext()).setImage((Session) request.getSession().getAttribute("someUser"), id, mimeType, input);
            }

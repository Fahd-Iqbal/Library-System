    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           if (request.getSession().getAttribute("someUser") == null){
            ...
            int id = BookRepository.getInstance(getServletContext()).addBook((Session) request.getSession().getAttribute("someUser"), book);
            ...
            if (mimeType.contains("image/")) {
                BookRepository.getInstance(getServletContext()).setImage((Session) request.getSession().getAttribute("someUser"), id, mimeType, is);
            }

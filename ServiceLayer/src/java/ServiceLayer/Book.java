...
private IBookRepository singleton = null;
   ...
   // reading book objects and putting to json objects
    for(core.Book b :singleton.listBooks() ){
       JSONObject book = new JSONObject(); 
       book.put("FirstName",b.getAuthorFirstName());
       ...
       book.put("PublisherAdress", b.getPublisherAddress());
       book.put("publisherCompany",b.getPublisherCompany());
